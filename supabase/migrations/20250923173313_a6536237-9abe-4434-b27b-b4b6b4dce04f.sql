...
ADD COLUMN IF NOT EXISTS competencias_seleccionadas text[] DEFAULT '{}',
ADD COLUMN IF NOT EXISTS contenidos_programa text,
ADD COLUMN IF NOT EXISTS mapeo_competencias_contenidos jsonb DEFAULT '{}',
ADD COLUMN IF NOT EXISTS requerimientos_docente text,
ADD COLUMN IF NOT EXISTS distribucion_modalidades jsonb DEFAULT '{"individual": 25, "pareja": 25, "grupos": 25, "toda_clase": 25}',
ADD COLUMN IF NOT EXISTS estrategias_diferenciacion text;
