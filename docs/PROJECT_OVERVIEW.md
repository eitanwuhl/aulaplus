...
> **Purpose**: Complete, repository-derived explanation of the project's architecture and implementation. This is the canonical onboarding/overview document — for operational contracts and guardrails see `docs/ARCHITECTURE_SSoT.md`.
...
1. **`docs/PROJECT_OVERVIEW.md`** (this file; originally created as `PROJECT_ARCHITECTURE_DEEP_DIVE.md`, renamed during repo cleanup as the canonical onboarding doc)
